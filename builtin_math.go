...
func createMathTemplate() *objectTemplate {
	...
	// extend
	t.putStr("mean", func(r *Runtime) Value { return r.methodProp(r.math_mean, "mean", 0) })
	t.putStr("median", func(r *Runtime) Value { return r.methodProp(r.math_median, "median", 0) })
	t.putStr("var", func(r *Runtime) Value { return r.methodProp(r.math_var, "var", 0) })
	t.putStr("std", func(r *Runtime) Value { return r.methodProp(r.math_std, "std", 0) })
